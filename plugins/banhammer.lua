...
local function kick_ban_res(extra, success, result) 
     ...
     local from_id = extra.from_id 
      ...
      elseif get_cmd == 'ban' then 
        ...
        send_large_msg(receiver, ' ♓️Username @'..member..' \n🆔 id ['..member_id..'] \n کُارٌُبٌرٌُ بٌه👆ُ عُلٌـتٌ کُوُنُی بٌوُـכنُ بٌنُ شُـכ😼 ') 
      ban_user(member_id, chat_id) 
      elseif get_cmd == 'unban' then 
        send_large_msg(receiver, ' ♓️Username @'..member..' \n🆔 id ['..member_id..'] \n کُارٌُبٌرٌُ کُوُنُیمُوُن🖕ُ  ﺂنُ بٌنُ شُـכ😾 ') 
        local hash =  'banned:'..chat_id 
        redis:srem(hash, member_id) 
        return ' کُارٌُبٌرٌُ کُوُنُی '..user_id..' ﺂنُ بٌنُ شُـכ ' 
      elseif get_cmd == 'banall' then 
        send_large_msg(receiver, ' ♓️Username @'..member..' \n🆔 id ['..member_id..'] \n کُارٌُبٌرٌُ بٌه👆ُ عُلٌـتٌ کُوُنُی بٌوُـכنُ گٌلٌـوُبٌالٌـ بٌنُ شُـכ😼') 
      banall_user(member_id) 
      elseif get_cmd == 'unbanall' then 
        send_large_msg(receiver, ' ♓️Username @'..member..' \n🆔 id ['..member_id..'] \n کُارٌُبٌرٌُ کُوُنُیمُوُن🖕ُ گٌلٌـوُبٌالٌـ ﺂنُ بٌنُ شُـכ😾 ') 
      ...
      if string.match(targetuser, '^%d+$') then 
        if tonumber(matches[2]) == tonumber(our_id) then 
           ...
           banall_user(targetuser) 
             return ' کُارٌُبٌرٌُ کُوُنُی ['..user_id..' ] گٌلٌـوُبٌابٌ بٌنُ شُـכ ' 
     else 
   local cbres_extra = { 
      chat_id = msg.to.id, 
      get_cmd = 'banall', 
